...
<body style="background-color: pink;">
    <div class="row">
        <div class="login_col1">
            <h5 style="margin-bottom: 40px;padding-top:20px; margin-left: 40px;"> <img src="{{URL('images/small-icon.png')}}" style="height:20px;width:20px;">Pet Parade</h5>
        ...
        <div class="login_col2">
            ...
            <img src="{{URL('images/pawpad.png')}}"
                ...
                <div class="register">
                    <p>Already have an account? <a href="Lohin.blade.php" style="color: hotpink;">
                            Sign In</a></p>
                </div>
            </form>
